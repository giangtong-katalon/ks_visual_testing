...
// Check appointment section with TestOps Visual Testing
...
// Check Facility with TestOps Visual Testing
...
// Check medicare with TestOps Visual Testing
...
//for (int i = 1; i <= 100; i++) {
//	int width = rd.nextInt(600) + 50
//	int height = rd.nextInt(600) + 50
//	WebUI.takeAreaScreenshotAsCheckpoint("Checkpoint " + width + "x" + height, new Rectangle(0, 0, height, width))
//}

//for (int i = 1; i <= 100; i++) {
//	// Check Full Appointment with TestOps Visual Testing
//	WebUI.takeFullPageScreenshotAsCheckpoint('Same resolution ' + i)
//}
